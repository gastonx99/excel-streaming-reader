...
public class StreamingReaderTest {
    ...
    public void testSheetName_missingInFile() throws Exception {
        ...
        try {
            StreamingReader reader = StreamingReader.builder().sheetName("adsfasdfasdfasdf").read(f);
            fail("Should have failed");
    ...
    public void testIteration() throws Exception {
        ...
        StreamingReader reader = StreamingReader.builder().rowCacheSize(5).read(f);
        int i = 1;
        for (Row r : reader) {
    ...
    public void testClosingFiles() throws Exception {
        OPCPackage o =
                OPCPackage.open(new File("src/test/resources/blank_cell_StringCellValue.xlsx"), PackageAccess.READ);
        o.close();
    }
}
