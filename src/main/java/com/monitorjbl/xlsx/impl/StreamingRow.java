...
public class StreamingRow implements Row {
    ...
    /**
     * Get the cell representing a given column (logical cell) 0-based. If you ask for a cell that is not defined, you
     * get a null.
     *
     * @param cellnum
     ...
     * 
     * @return short representing the last logical cell in the row <b>PLUS ONE</b>, or -1 if the row does not contain
     *         any cells.
     */
    @Override
