...
public class StreamingWorkbookReader implements Iterable<Sheet> {
    ...
    void loadSheets(XSSFReader reader, SharedStringsTable sst, StylesTable stylesTable, int rowCacheSize)
        ...
        while (iter.hasNext()) {
            ...
            sheets.add(new StreamingSheet(sheetNames.get(i++), new StreamingSheetReader(sst, stylesTable, parser,
                    rowCacheSize)));
        }
    }
